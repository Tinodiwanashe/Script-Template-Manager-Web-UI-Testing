...
class VerifyDataInWebTable {

	public static WebDriver driver =null;

	@Keyword
	public static void verify_expText_In_Colum_Table(TestObject tableObject,String expText,int expTextColNum) throws Exception {
	...
	@Keyword
	public static void verify_Deleted_ExpText_In_Colum_Table(TestObject tableObject,String expText,int expTextColNum) throws Exception {
		boolean status = false;
		boolean page = true;
		String actText = null;
		try {
	...
	@Keyword
	public static void verify_MultipleTexts_In_Colum_Table(TestObject tableObject,String expText1,int expText1ColNum,String expText2,int expText2ColNum) throws Exception {
		boolean status = false;
		boolean page = true;
	...
	@Keyword
	public static void EditDelete_Click_Operation_In_WebTable(TestObject tableObject, String expText,int expTextColNum,String clickOperation,int clickOperationColNum,String clickAttribute) throws Exception {
		boolean status = false;
		boolean page = true;
		String actText = null;
		try {
	...
	@Keyword
	public static void Peform_AnchorClick_Operation_In_Table(TestObject tableObject, String expText,int expTextColNum,int clickOperationColNum) throws Exception {
		boolean status = false;
		boolean page = true;
		String actText = null;
		try {
